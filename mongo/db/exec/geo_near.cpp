...
namespace mongo {
    ...
    namespace {
        ...
        public:
            ...
            virtual bool matchesSingleElement(const BSONElement& e) const {
				log() << "MATCH SINGLE ELEMTN TWODPTINANNULUSEXPRESSION" << endl;
                if (!e.isABSONObj())
                    return false;
        ...
        public:
            ...
            virtual bool matchesSingleElement(const BSONElement& e) const {
				log() << "MATCH SINGLE ELEMTN TWODINREGIONEXPRESSION" << endl;
    ...
    namespace {
        ...
        public:
            ...
            virtual bool matchesSingleElement(const BSONElement& e) const {
				log() << "MATCH SINGLE ELEMTN TWODSPHEREKEYINREGIONEXPRESSION" << endl;
                // Something has gone terribly wrong if this doesn't hold.
